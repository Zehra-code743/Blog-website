        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
          <div>
            ...
            <ul className="space-y-3">
              <li>
                <a href="javascript:void(0)" className="text-gray-400 hover:text-white text-sm transition-all">Cybersecurity</a>
              </li>
              <li>
                <a href="javascript:void(0)" className="text-gray-400 hover:text-white text-sm transition-all">Hackers</a>
              </li>
              <li>
